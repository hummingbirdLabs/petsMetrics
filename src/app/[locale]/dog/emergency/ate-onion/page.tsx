...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  ...
  const metaTitle = t('ateOnion.meta.title');
  const metaDesc = t('ateOnion.meta.description');
  const metaKw = t('ateOnion.meta.keywords');
  const ogTitle = t('ateOnion.article.ogTitle');
  const ogDesc = t('ateOnion.article.ogDescription');
  ...
  return {
    ...
    keywords: metaKw,
    alternates: {
      canonical: `${SITE_URL}/${locale}/dog/emergency/ate-onion/`,
    },
    openGraph: {
      title: ogTitle,
      description: ogDesc,
      url: `${SITE_URL}/${locale}/dog/emergency/ate-onion/`,
      type: 'article',
...
export default async function DogAteOnionPage({ params }: { params: { locale: string } }) {
  const { locale } = params;
  ...
  const breadcrumbItem = t('ateOnion.breadcrumbLabel');
  ...
  const steps = t.raw('ateOnion.steps') as Array<{ title: string; content?: string }>;
