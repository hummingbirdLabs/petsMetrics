  ...
  return (
    <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            {matingDates.length < 3 ? (
              <button
                ...
                className="self-start text-sm font-medium text-[--cat-primary] hover:underline"
              >
      ...
      {result ? (
        <>
          {/* Due Date Hero */}
          <div className="rounded-xl border-l-4 bg-[--cat-surface] border-l-[--cat-primary]">
            <div className="flex flex-col gap-3 p-6">
              <span className="text-sm font-medium text-[--cat-primary]">{t('result.expectedDate')}</span>
